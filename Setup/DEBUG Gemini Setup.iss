...
#define AppVer ParseVersion("..\GeminiTelescope\bin\x86\Debug\ASCOM.GeminiTelescope.exe", Major ,Minor ,Release ,Build) ; define version variables
...
Source: ..\GeminiTelescope\bin\x86\Debug\ASCOM.GeminiTelescope.exe; DestDir: {cf}\ASCOM\Telescope\Gemini; Check: Is64BitInstallMode; Flags: ignoreversion
Source: ..\GeminiTelescope\bin\x86\Debug\ASCOM.GeminiTelescope.pdb; DestDir: {cf}\ASCOM\Telescope\Gemini; Check: Is64BitInstallMode; Flags: ignoreversion
...
Source: ..\GeminiTelescope\bin\x86\Debug\Interop.SpeechLib.dll; DestDir: {cf}\ASCOM\Telescope\Gemini; Check: Is64BitInstallMode; Flags: ignoreversion
...
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: Is64BitInstallMode; Flags: ignoreversion; Tasks: ; Languages: 
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.pdb; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: Is64BitInstallMode; Flags: ignoreversion
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: NotIs64BitInstallMode; Flags: ignoreversion
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.pdb; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: NotIs64BitInstallMode; Flags: ignoreversion

Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.2.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: Is64BitInstallMode; Flags: ignoreversion; Tasks: ; Languages: 
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.2.pdb; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: Is64BitInstallMode; Flags: ignoreversion
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.2.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: NotIs64BitInstallMode; Flags: ignoreversion
Source: ..\GeminiTelescopeServedClasses\ASCOM.GeminiTelescope.Telescope.2.pdb; DestDir: {cf}\ASCOM\Telescope\Gemini\GeminiTelescopeServedClasses; Check: NotIs64BitInstallMode; Flags: ignoreversion



; Language resources
Source: ..\GeminiTelescope\bin\x86\Debug\en-GB\ASCOM.GeminiTelescope.resources.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\en-GB; Check: Is64BitInstallMode; Flags: ignoreversion
...
Source: ..\GeminiTelescope\bin\x86\Debug\ru\ASCOM.GeminiTelescope.resources.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\ru; Check: Is64BitInstallMode; Flags: ignoreversion
...
Source: ..\GeminiTelescope\bin\x86\Debug\fr\ASCOM.GeminiTelescope.resources.dll; DestDir: {cf}\ASCOM\Telescope\Gemini\fr; Check: Is64BitInstallMode; Flags: ignoreversion
